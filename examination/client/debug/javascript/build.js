...
},{"./config.json":7}],3:[function(require,module,exports){
/**
 *
 * @author: beppek
 * @version: 0.1.0
...
},{"./questions/1.json":8,"./questions/2.json":9,"./questions/3.json":10,"./questions/4.json":11,"./questions/5.json":12,"./questions/6.json":13,"./questions/7.json":14,"jQuery":15}],4:[function(require,module,exports){
/**
 *
 * @author: leitet
 * @author: beppek (edits and addons)
...
},{"./About":1,"./Chat":2,"./Destination":3,"./Memory":4,"jQuery":15}],6:[function(require,module,exports){
/**
 *
 * @author: beppek
 * @version: 1.0.0
...
},{"./Window":5,"jQuery":15}],7:[function(require,module,exports){
module.exports={
...
module.exports={
    ...
    "info": "Nepal has a rather interesting flag, in fact it is the only nation with a flag that is not rectangular in shape but rather made up of two triangles.",
    "question": "The inspiration for the flag is said to come from the building in this picture and the mighty mountain chain in the background. What is this kind of architecture called?",
    "options": [
        {"option": "Pagoda"},
        {"option": "Feng Shui"}
    ],
    "rightAnswer": "Pagoda",
    "correct": "Correct! A pagoda is a tiered tower with multiple eaves, built in traditions originating in historic East Asia. The modern pagoda is an evolution of the Ancient Nepal stupa, a tomb-like structure where sacred relics could be kept safe and venerated.",
    "wrong": "Sorry, wrong answer. A pagoda is a tiered tower with multiple eaves, built in traditions originating in historic East Asia. The modern pagoda is an evolution of the Ancient Nepal stupa, a tomb-like structure where sacred relics could be kept safe and venerated."
...
module.exports={
    ...
    "info": "Nepal is a landlocked country bordering the world's 2 most populous nations, India to the south and China to the north.",
    "question": "The world's highest mountain chain runs along the northern border of Nepal, what is it called?",
    "options": [
        {"option": "The Andes"},
        {"option": "The Scandes"},
        {"option": "The Himalayas"}
    ],
    "rightAnswer": "The Himalayas",
    "correct": "Correct! The Himalayas (meaning \"abode of snow\" in sanskrit) is home to 9 of the 10 highest peaks on earth, including the highest mountain above sea level, Mount Everest.",
    "wrong": "Sorry, wrong answer. The Himalayas (meaning \"abode of snow\" in sanskrit) is home to 9 of the 10 highest peaks on earth, including the highest mountain above sea level, Mount Everest."
...
module.exports={
    ...
    "info": "Buddha's birthplace is often attributed to Nepal even though he spent most of his life in India. Buddha was a sage whose teachings became the foundation of buddhism, however Buddha was not his real name but rather a taken one meaning: \"the enlightened one\".",
    "question": "What was Buddha's real name?",
    "options": [
        {"option": "Confucius"},
        {"option": "Mahatma Gandhi"},
        {"option": "Siddhartha Gautama"},
        {"option": "Tirthankara"}
    ],
    "rightAnswer": "Siddhartha Gautama",
    "correct": "Correct! According to the Buddhist tradition, Siddhartha Gautama was born in Lumbini, now in modern-day Nepal, and raised in the Shakya capital of Kapilvastu, which may have been in either present day Tilaurakot, Nepal or Piprahwa, India. He obtained his enlightenment in Bodh Gaya, gave his first sermon in Sarnath, and died in Kushinagar.",
    "wrong": "Sorry, wrong answer. According to the Buddhist tradition, Siddhartha Gautama was born in Lumbini, now in modern-day Nepal, and raised in the Shakya capital of Kapilvastu, which may have been in either present day Tilaurakot, Nepal or Piprahwa, India. He obtained his enlightenment in Bodh Gaya, gave his first sermon in Sarnath, and died in Kushinagar."
...
module.exports={
    ...
    "info": "Moving on. The Nepali economy is still very rural and local meaning a lot of crafts survive until this day. In the image we see a woman walking through the smoke from a pottery burning fire.",
    "question": "The Nepali make a special kind of usually very colourful fabric from the wool of a special breed of goat, what is that fabric (and the goat breed) called?",
    "options": [
        {"option": "Pashmina"},
        {"option": "Changpa"},
        {"option": "Yak"},
    ],
    "rightAnswer": "Pashmina",
    "correct": "Correct! The fibre is also known as pashm or pashmina for its use in the handmade shawls of the Himalayas.",
    "wrong": "Sorry, wrong answer. The fibre is also known as pashm or pashmina for its use in the handmade shawls of the Himalayas."
...
module.exports={
    ...
    "info": "Kathmandu valley is home to many UNESCO world heritage sites, most of which were severely damaged by the magnitude 8 earth quake that struck the area in April 2015.",
    "question": "How many UNESCO world heritage sites can be found in the Kathmandu Valley?",
    "options": [
        {"option": "2"},
        {"option": "9"},
        {"option": "7"},
    ...
    "rightAnswer": "7",
    "correct": "Correct! The cultural heritage of the Kathmandu Valley is illustrated by seven groups of monuments and buildings for which the Kathmandu Valley is world famous. The seven include the Durbar Squares of Hanuman Dhoka (Kathmandu), Patan (pictured) and Bhaktapur, the Buddhist stupas of Swayambhu and Bauddhanath and the Hindu temples of Pashupati and Changu Narayan.",
    "wrong": "Sorry, wrong answer. The cultural heritage of the Kathmandu Valley is illustrated by seven groups of monuments and buildings for which the Kathmandu Valley is world famous. The seven include the Durbar Squares of Hanuman Dhoka (Kathmandu), Patan (pictured) and Bhaktapur, the Buddhist stupas of Swayambhu and Bauddhanath and the Hindu temples of Pashupati and Changu Narayan."
